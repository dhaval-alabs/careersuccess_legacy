...
const HIGHLIGHTS = [
  ...
  { icon: "🏛️", title: "Real Classroom and Flexible Learning", desc: "Learn in-person in Noida, Gurgaon, or Bangalore. Or join live online sessions with the same faculty. Blend modes as your schedule demands." },
  { icon: "🤖", title: "Generative AI Built Into the Curriculum", desc: "Not an afterthought. Prompt engineering, AI-assisted coding for Python and SQL, and GenAI for data visualisation and reporting are part of the standard syllabus. Curriculum updated quarterly to reflect the latest tools." },
...
export default function NoidaDSAIPage() {
  ...
  const FAQS = [
    { q: "How much does the data science course cost?", a: "The Advanced Certification in Data Science and AI starts at Rs.53,100 (incl. taxes) for Blended eLearning, Rs.59,000 for Live Online, and Rs.68,440 for Classroom. 0% interest EMI available across all modes." },
    { q: "Does this data science course come with a placement guarantee?", a: "Yes. Placement with Fee-Back Guarantee. Complete the programme, meet the requirements, and if you are not placed within 6 months, we refund 50% of your course fee. 700+ companies have hired our alumni." },
    { q: "What is the eligibility for this data science course?", a: "No prior coding experience required. The programme starts from Excel, SQL, and Python foundations. 20,000+ candidates trained, including many from non-technical backgrounds." },
    { q: "What is covered in the data science course syllabus?", a: "11 modules across 700+ hours: Excel, SQL, Power BI, Python, Applied Statistics, Machine Learning (supervised and unsupervised), Text Mining and NLP, Deep Learning, Model Deployment and MLOps, Generative AI (prompt engineering, GenAI for Python/SQL/BI workflows), and Capstone Projects. AI is integrated into the core curriculum." },
    { q: "What data science certification do I receive?", a: "Dual certification from NASSCOM-FutureSkills Prime (backed by MeitY, Government of India) and AnalytixLabs. Recognised globally and shareable on LinkedIn." },
    { q: `Do you offer data science classroom training ${config.h1City}?`, a: config.faq6answer },
    { q: "Can I do this data science course while working full-time?", a: "Yes. The programme is built for working professionals. Weekend sessions, blended learning mode for self-pacing, and recorded classes for flexible revision." },
    { q: "What data scientist salary can I expect after completing this?", a: "Freshers can expect Rs.6-10 LPA. Experienced professionals transitioning into data science roles typically see Rs.20-35 LPA. Alumni placements have reached up to Rs.42 LPA." },
    { q: "Does this course cover AI, Generative AI, and machine learning?", a: "Yes. Machine Learning (supervised, unsupervised, ensemble methods), Deep Learning, NLP, and a dedicated Generative AI module are all part of the core programme. The GenAI module covers prompt engineering, AI-assisted coding for Python and SQL, and using AI tools across the data science workflow. This is one of the few data science courses in India where AI is integrated into the standard curriculum. For learners who want to go deeper into AI, AnalytixLabs also offers standalone AI courses." },
    { q: "How does this compare to a PG or master's degree in data science?", a: "University programmes offer breadth and theory. AnalytixLabs is applied, job-ready, and updated quarterly. The curriculum includes tools and techniques most universities will not cover for 2-3 years." },
    { q: "How is this different from data science courses on Coursera or Udemy?", a: "Live instruction, 6 capstone projects, an 8-week placement programme, NASSCOM certification, and a dedicated career team. Not comparable to self-paced MOOCs." },
    { q: `What is the best data science course ${config.h1City}?`, a: `20,000+ candidates trained, 700+ companies that have hired our alumni, 9.6/10 student rating, NASSCOM-FutureSkills Prime accreditation. ${config.faq6answer} Also serves learners from ${config.faq12nearby}.` },
  ];
            ...
            <div>
              <div className="mb-10 flex items-center gap-4 sm:gap-8">
                <div className="flex-shrink-0">
                  <Image src="/lp/images/alabs-hd.webp" alt="AnalytixLabs Icon" width={48} height={48} className="w-auto h-[3.5rem] sm:hidden max-w-[30vw] object-contain" priority sizes="(max-width: 640px) 48px, 0px" />
                  <Image src="/lp/images/analytixlabs-logo.webp" alt="AnalytixLabs - Data Science Training Institute" width={180} height={40} className="w-auto h-[4rem] hidden sm:block" priority sizes="(min-width: 640px) 180px, 0px" />
                </div>
                <div className="w-px h-8 bg-[#D6ECEB]" />
                <Image src="/lp/images/Final-Logo-IITP-IITB-2026.webp" alt="IIT Bombay, IIT Patna and Nasscom — Partners" width={300} height={60} className="w-auto h-[4.5rem] sm:h-[6.5rem] max-w-[65vw] sm:max-w-none object-contain" priority />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="relative rounded-3xl overflow-hidden p-9 border border-[#D6ECEB] shadow-lg" style={{ background: 'linear-gradient(45deg, #FEFBE5, #E6FBF1, #ECFAFE)' }}>
                ...
                <div className="relative">
                  ...
                  <p className="text-[#4A6275] text-lg leading-relaxed mb-8 font-medium">Complete the programme, meet the requirements, and if you are not placed in a qualifying role within 6 months, we refund 50% of your course fee.</p>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-16">
              <div className="max-w-3xl">
                ...
                <h2 className="text-[#09263F] font-bold text-4xl sm:text-5xl leading-tight mb-4">
                  ...
                  <span className="bg-gradient-to-r from-[#19dfaf] to-[#07b2e8] bg-clip-text text-transparent">700+ Hours</span> of Data Science and AI
                </h2>
                <p className="text-[#4A6275] text-lg leading-relaxed">
                  11 modules covering analytics, data science, ML, and Generative AI. Curriculum designed with NASSCOM-FutureSkills Prime.
                </p>
              </div>
            </div>
                ...
                <div className="flex flex-col items-center gap-10">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 w-full">
                    <div className="bg-white p-6 rounded-2xl shadow-xl border border-[#D6ECEB] transform transition-transform hover:scale-[1.03]">
                      <Image src="/lp/images/Nasscom-Certification-1024x724-1-300x212.jpg" alt="NASSCOM Certification" width={600} height={420} className="w-full h-auto rounded-lg shadow-sm" sizes="(max-width: 768px) 100vw, 300px" />
                      <p className="text-[#09263F] font-bold text-sm mt-4 text-center">NASSCOM FutureSkills Prime</p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-xl border border-[#D6ECEB] transform transition-transform hover:scale-[1.03]">
                      <Image src="/lp/images/Alabs_DS-Advanced-Certification-in-Data-Science-AI-300x212.jpg" alt="AnalytixLabs Certification" width={600} height={420} className="w-full h-auto rounded-lg shadow-sm" sizes="(max-width: 768px) 100vw, 300px" />
