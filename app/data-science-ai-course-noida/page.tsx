            ...
            <div>
              <div className="mb-10 flex items-center gap-4 sm:gap-8">
                <div className="flex-shrink-0">
                  <Image src="https://www.analytixlabs.co.in/wp-content/uploads/2026/03/alabs-hd.webp" alt="AnalytixLabs Icon" width={48} height={48} className="w-auto h-[4.5rem] sm:hidden max-w-[30vw] object-contain" priority sizes="(max-width: 640px) 48px, 0px" />
                  <Image src="https://careersuccess.analytixlabs.co.in/wp-content/uploads/2025/03/analytixlabs-logo.webp" alt="AnalytixLabs - Data Science Training Institute" width={180} height={40} className="w-auto h-[3.5rem] hidden sm:block" priority sizes="(min-width: 640px) 180px, 0px" />
                </div>
                <div className="w-px h-8 bg-[#D6ECEB]" />
                <Image src="https://www.analytixlabs.co.in/wp-content/uploads/2026/03/logo-nasscom-ministry.webp" alt="Nasscom Futureskills - Ministry of Electronics and Information Technology" width={160} height={40} className="w-auto h-[5.25rem] max-w-[55vw] sm:max-w-none object-contain" priority sizes="(max-width: 640px) 260px, 160px" />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-3 mb-10">
                {["Classroom", "Live Online", "Blended", "Generative AI in Core Curriculum", "Placement + Fee-Back Guarantee", "NASSCOM-FutureSkills Prime Certified"].map((item) => (
