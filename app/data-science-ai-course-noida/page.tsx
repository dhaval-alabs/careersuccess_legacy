            ...
            <div>
              <div className="mb-10 flex items-center gap-4 sm:gap-8">
                <div className="flex-shrink-0">
                  <Image src="https://www.analytixlabs.co.in/wp-content/uploads/2026/03/alabs-hd.webp" alt="AnalytixLabs Icon" width={48} height={48} className="w-auto h-[3.5rem] sm:hidden max-w-[30vw] object-contain" priority sizes="(max-width: 640px) 48px, 0px" />
                  <Image src="https://careersuccess.analytixlabs.co.in/wp-content/uploads/2025/03/analytixlabs-logo.webp" alt="AnalytixLabs - Data Science Training Institute" width={180} height={40} className="w-auto h-[4rem] hidden sm:block" priority sizes="(min-width: 640px) 180px, 0px" />
                </div>
                <div className="w-px h-8 bg-[#D6ECEB]" />
                <Image src="https://www.analytixlabs.co.in/wp-content/uploads/2024/12/Final-Logo-IITP-IITB-2026.webp" alt="IIT Bombay, IIT Patna and Nasscom — Partners" width={300} height={60} className="w-auto h-[4.5rem] sm:h-[6.5rem] max-w-[65vw] sm:max-w-none object-contain" priority />
              </div>
