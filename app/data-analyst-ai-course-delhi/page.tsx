...
export default function DelhiDAAIPage() {
  ...
  return (
    <div className="font-sans bg-white text-[#1A2E3B] antialiased">
      <main id="main-content">
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 py-16 lg:py-24 grid lg:grid-cols-[1fr_500px] gap-12 items-center">
            <div>
              ...
              <p className="text-[#4A6275] text-base leading-relaxed mb-6 max-w-xl">
                SQL, Power BI, Python, and Generative AI — all in one programme, certified by NASSCOM FutureSkills Prime with co-certification from TIH at IIT Bombay or TIH at IIT Patna. Classroom and Live online batches in Delhi.
              </p>
        ...
        <CourseInfoSection locations={['noida', 'gurgaon']} courseType="da" />
