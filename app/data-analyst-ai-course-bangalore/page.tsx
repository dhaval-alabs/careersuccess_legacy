...
export default function BangaloreDAPage() {
  const [formOpen, setFormOpen] = useState(false);
  const [formSource, setFormSource] = useState("lp_data_analyst_bangalore");
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <HeroSection 
        title="Best Data Analytics + AI Course in Bangalore"
        subtitle="Ranked #1 Data Analytics Institute in Bangalore. Master SQL, Power BI, Python & GenAI at our HSR Layout centre. Get NASSCOM certified with 100% placement support."
