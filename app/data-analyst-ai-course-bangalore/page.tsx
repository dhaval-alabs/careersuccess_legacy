...
const HIGHLIGHTS = [
  ...
  { icon: "🏛️", title: "Real Classroom and Flexible Learning", desc: "Learn in-person in Bangalore (HSR Layout). Or join live online sessions with the same faculty. Blend modes as your schedule demands." },
...
export default function BangaloreDAAIPage() {
  ...
  const FAQS = [
    { q: "How much does the Data Analyst + AI course cost?", a: "The Data Analyst + AI programme is Rs.53,100 (incl. taxes) for Blended eLearning, Rs.59,000 for Interactive Live Online, and Rs.68,440 for Classroom and Bootcamp. TIH at IIT Bombay or IIT Patna co-certified tracks are Rs.70,800, Rs.80,240 and Rs.87,320 respectively. 0% interest EMI available." },
  ...
  return (
    <div className="font-sans bg-white text-[#1A2E3B] antialiased">
      <main id="main-content">
        ...
        <CourseInfoSection locations={['bangalore']} courseType="da" />
