...
export default function NoidaDAPage() {
  const [formOpen, setFormOpen] = useState(false);
  const [formSource, setFormSource] = useState("lp_data_analyst_noida");
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <HeroSection 
        title="Best Data Analytics + AI Course in Noida"
        subtitle="Ranked #1 Data Analytics Institute in Noida. Learn SQL, Power BI, Python & GenAI at our Sector 15 centre. Get NASSCOM certified with 100% placement support."
