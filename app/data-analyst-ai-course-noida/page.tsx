...
const config = {
  h1City: "in Noida",
  subhead: "Master Data Analytics with Generative AI. Learn SQL, Power BI, Python, and AI-assisted analytics. NASSCOM-certified course with 100% placement support at our Sector 15, Noida centre.",
