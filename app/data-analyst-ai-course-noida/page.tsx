...
const config = {
  h1City: "in Noida",
  subhead: "Master Data Analytics with Generative AI. Learn SQL, Power BI, Python, and AI-assisted analytics. Complete course with 100% placement support at our Noida centre.",
...
const HIGHLIGHTS = [
  ...
  { icon: "🏛️", title: "Real Classroom and Flexible Learning", desc: "Learn in-person in Noida. Or join live online sessions with the same faculty. Blend modes as your schedule demands." },
  ...
  return (
    <div className="font-sans bg-white text-[#1A2E3B] antialiased">
      <main id="main-content">
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 py-16 lg:py-24 grid lg:grid-cols-[1fr_500px] gap-12 items-center">
            <div>
              ...
              <p className="text-[#4A6275] text-base leading-relaxed mb-6 max-w-xl">
                SQL, Power BI, Python, and Generative AI — all in one programme, certified by NASSCOM FutureSkills Prime with co-certification from TIH at IIT Bombay or TIH at IIT Patna. Classroom and Live online batches in Noida.
              </p>
        ...
        <CourseInfoSection locations={['noida']} courseType="da" />
