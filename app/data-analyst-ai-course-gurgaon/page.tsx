...
export default function GurgaonDAPage() {
  const [formOpen, setFormOpen] = useState(false);
  const [formSource, setFormSource] = useState("lp_data_analyst_gurgaon");
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <HeroSection 
        title="Best Data Analytics + AI Course in Gurgaon"
        subtitle="Ranked #1 Data Analytics Institute in Gurgaon. Master SQL, Power BI, Python & GenAI at our Sector 44 centre. Get NASSCOM certified with 100% placement support."
