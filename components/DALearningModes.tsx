...
const BlendedIcon = () => (
  <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
    ...
    <path d="M20 26 Q22 29 24 26" stroke="#F5C842" strokeWidth="2" strokeLinecap="round" fill="none"/>
...
export default function DALearningModes({ onOpenDemo }: { onOpenDemo?: () => void }) {
    ...
    <section className="py-20 px-6" style={{ background: "#f0faf8" }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          >
            <span className="bg-gradient-to-r from-[#19dfaf] to-[#07b2e8] bg-clip-text text-transparent">DATA ANALYST COURSE FEES</span>
          </span>
          <h2
          ...
          <p className="text-sm max-w-md mx-auto" style={{ color: "#4A6275" }}>
            Same syllabus, same faculty, same NASSCOM certification. Pick what fits your schedule and budget. 0% interest EMI available on all modes.
          </p>
        </div>
